...
[![General Workflow](https://github.com/gexec/community.gexec/actions/workflows/general.yml/badge.svg)](https://github.com/gexec/community.gexec/actions/workflows/general.yml) [![Codacy Badge](https://app.codacy.com/project/badge/Grade/f2a0185ebf014efdb11f9d57aa488cf2)](https://app.codacy.com/gh/gexec/community.gexec/dashboard?utm_source=gh&utm_medium=referral&utm_content=&utm_campaign=Badge_grade) [![Discord](https://img.shields.io/discord/1335976189025849395)](https://discord.gg/Yda8rD4ZkJ)

Within this repository we define the collection to manage any or your instance
of [Gexec](https://gexec.eu).

## Usage

If you want to install the collection directly with the help of the
`ansible-galaxy` command simply execute the following command:

```console
ansible-galaxy collection install gexec.gexec
```

If you prefer some GitOps style and you already got a requirements.yml within
your repository you can also just add it to the file:
